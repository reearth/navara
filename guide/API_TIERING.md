...
Plugins receive a `ThreeView` reference via `init(view)`. Layer declarations receive a `ViewContext` instance, which provides controlled access to rendering internals:
