...
use super::{UpsampleTerrainMeshMarker, UpsampleTerrainMeshParameters};
use crate::{
...
pub(crate) fn upsample_terrain_mesh(
    ...
    constructors: Query<
        (Entity, &UpsampleTerrainMeshParameters, &OrderByDistance),
        ...
        .take(num_take)
    {
        let delegatee_id = commands
            .spawn(DelegatedWorkerTasksParametersBundle::new(
                ...
                DelegatedWorkerTasksParameters::UpsampleTerrainMesh(DelegatedWorkerTask::new(
                    e,
                    constructor.clone(),
                )),
                Priority::High,
