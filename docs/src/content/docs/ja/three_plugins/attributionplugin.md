...
| プロパティ      | 型                   | 説明                                                             |
| --------------- | -------------------- | ---------------------------------------------------------------- |
| `attribution`   | `string`             | トップレベルに表示されるデータソース名                           |
...
| プロパティ | 型       | 説明                                            |
| ---------- | -------- | ----------------------------------------------- |
| `title`    | `string` | クレジットテキスト。インライン `<a>` リンクを含めてよい |
| `minZoom`  | `number` | このクレジットが適用される最小ズーム（省略で下限なし） |
| `maxZoom`  | `number` | このクレジットが適用される最大ズーム（省略で上限なし） |
