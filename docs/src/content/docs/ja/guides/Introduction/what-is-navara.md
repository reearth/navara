...
Three.js レンダリングバックエンドは、大気散乱、シャドウマッピング、ボリュメトリッククラウド、ポストプロセッシングエフェクトなど、フォトリアルな描画機能を備えています。これらはすべてプラグインシステムを通じて合成可能なエフェクトレイヤーとして利用できます。
