---
title: About
description: three_default_descs の概要と特徴について説明します。
sidebar:
  order: 1
---
...
詳細は [Mesh Desc Reference](../../../three_default_descs/mesh-desc/about/) を参照してください。
...
詳細は [Effect Desc Reference](../../../three_default_descs/effect-desc/about/) を参照してください。
...
詳細は [Light Desc Reference](../../../three_default_descs/light-desc/about/) を参照してください。
