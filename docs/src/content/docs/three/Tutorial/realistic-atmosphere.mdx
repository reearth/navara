...
This tutorial builds on the project from [Getting Started](../../../guides/introduction/getting-started/).

In addition, this tutorial imports Descriptor types such as `CloudsEffectDesc` and `RainMeshDesc` from `@navaramap/three-default-descs`.
