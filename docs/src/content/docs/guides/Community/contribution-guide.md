...
To set up the development environment for each library, please refer to the README of the corresponding GitHub repository.
Each repository contains detailed setup instructions and local development methods.
...
1. Create an Issue or PR in the [documentation repository](https://github.com/reearth/navara)
