...
export type EffectUpdate = DeclarationConfigUpdate;
 ...
 *
 * const handle = view.addLayer<VignetteEffectDeclaration>({
 *   type: "effect",
 ...
 */
export abstract class EffectDeclaration<
...
> extends Declaration<Config, UpdateConfig, Instance> {
  ...
  getConstructor() {
    return this.constructor as typeof EffectDeclaration;
  }
   ...
   */
  findLayer<Layer extends EffectDeclaration = EffectDeclaration>(
    key: string,
  ) {
