 ...
 *
 * ```typescript
 * class MyLightLayer extends LightDeclaration<
 *   MyLightConfig,
 *   MyLightUpdate,
 *   PointLight
 * > {
 ...
 *
 * @see {@link AmbientLightDeclaration} for a minimal built-in example.
 * @see {@link SunLightDeclaration} for an advanced example with CSM shadows and atmosphere integration.
 *
 ...
 */
export abstract class LightDeclaration<
