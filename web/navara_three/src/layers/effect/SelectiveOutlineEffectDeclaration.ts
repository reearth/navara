 ...
 */
export class SelectiveOutlineEffectDeclaration extends SelectiveEffectDeclaration<
...
class SelectiveOutlinePass extends PostProcessingPass {
  private layer: SelectiveOutlineEffectDeclaration;
  ...
  constructor(layer: SelectiveOutlineEffectDeclaration) {
