...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@navara\/three$/, replacement: normalizePath(path.resolve(__dirname, "src/index.ts")) },
      ...
      { find: /^three$/, replacement: normalizePath(path.resolve(__dirname, "node_modules/three/src/Three.js")) },
      { find: "three/webgpu", replacement: normalizePath(path.resolve(__dirname, "node_modules/three/src/Three.WebGPU.js")) },
      { find: "three/tsl", replacement: normalizePath(path.resolve(__dirname, "node_modules/three/src/Three.TSL.js")) },
      { find: "@shaders", replacement: normalizePath(path.resolve(__dirname, "../../shaders")) },
    ],
  },
  define: {
