...
const layers: MaterialLayerDescription[] = [
  ...
  },
  {
    ...
    text: {
      ...
      clampToGround: true,
      depthTest: true,
      // text: "hello ADEL!!!, this is a very long text to test the rendering of instanced SDF text mesh in Navara Three. Let's see how it performs with a long string of text.",
      // font: "https://raw.githubusercontent.com/loveencounterflow/jizura-fonts/master/fonts/Roboto/Roboto-Black.ttf",
      text: "hello 京都!!!",
