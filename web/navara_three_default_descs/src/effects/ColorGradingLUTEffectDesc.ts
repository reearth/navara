...
export type ColorGradingLUTConfig = Description & EffectConfig;

export type ColorGradingLUTUpdate = Description & EffectUpdate;

export class ColorGradingLUTEffectDesc extends EffectDesc<
