...
export type SunLightConfig = LightConfig & LayerDescription;

export type SunLightUpdate = LightUpdate & LayerDescription;

export class SunLightDeclaration extends LightDeclaration<
  SunLightConfig,
  SunLightUpdate,
  SunLight
> {
  ...
  constructor(view: ViewContext, config: SunLightConfig) {
    super(view, config);
    this.config = config;
  }
