...
export type GLTFModelConfig = MeshConfig & LayerDescription;

export type GLTFModelUpdate = MeshUpdate & LayerDescription;
...
export class GLTFModelDeclaration extends MeshDeclaration<
  GLTFModelConfig,
  GLTFModelUpdate,
  Group,
  GLTFModelEvent
> {
  ...
  constructor(view: ViewContext, config: GLTFModelConfig) {
    super(view, config);
    this.config = {
      ...config,
      gltfModel: {
