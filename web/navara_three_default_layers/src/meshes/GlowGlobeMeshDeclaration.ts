...
export type GlowGlobeMeshConfig = MeshConfig & LayerDescription;

export type GlowGlobeMeshUpdate = MeshUpdate & LayerDescription;

export class GlowGlobeMeshDeclaration extends MeshDeclaration<
  GlowGlobeMeshConfig,
  GlowGlobeMeshUpdate,
  Mesh<SphereGeometry, ShaderMaterial>
> {
  private config: GlowGlobeMeshConfig;
  constructor(view: ViewContext, config: GlowGlobeMeshConfig) {
    super(view, config);
    this.config = config;
  }
