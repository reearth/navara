...
export type SmoothLineMeshConfig = MeshConfig & LayerDescription;

export type SmoothLineMeshUpdate = MeshUpdate & LayerDescription;

export class SmoothLineMeshDeclaration extends MeshDeclaration<
...
> {
  ...
  constructor(view: ViewContext, config: SmoothLineMeshConfig) {
    super(view, config);
    this.config = config;
  }
