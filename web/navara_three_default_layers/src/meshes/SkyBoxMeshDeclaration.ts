...
export type SkyBoxMeshConfig = MeshConfig & LayerDescription;

export type SkyBoxMeshUpdate = MeshUpdate & LayerDescription;
...
export class SkyBoxMeshDeclaration extends MeshDeclaration<
  SkyBoxMeshConfig,
  SkyBoxMeshUpdate,
  Mesh<BufferGeometry, ShaderMaterial>
> {
  private config: SkyBoxMeshConfig;
  constructor(view: ViewContext, config: SkyBoxMeshConfig) {
    super(view, config);
    this.config = config;
  }
