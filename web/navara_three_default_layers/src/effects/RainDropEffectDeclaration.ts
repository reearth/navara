...
export type RainDropConfig = LayerDescription & EffectConfig;

export type RainDropUpdate = LayerDescription & EffectUpdate;

export class RainDropEffectDeclaration extends EffectDeclaration<
  RainDropConfig,
  RainDropUpdate,
  RainDropEffect
> {
