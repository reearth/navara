...
export type CloudsConfig = LayerDescription & EffectConfig;

export type CloudsUpdate = LayerDescription & EffectUpdate;

export class CloudsEffectDeclaration extends EffectDeclaration<
  CloudsConfig,
  CloudsUpdate,
  Clouds
> {
