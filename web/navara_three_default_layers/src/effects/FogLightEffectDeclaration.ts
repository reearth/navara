...
export type FogLightConfig = LayerDescription & EffectConfig;

export type FogLightUpdate = LayerDescription & EffectUpdate;

export class FogLightEffectDeclaration extends EffectDeclaration<
  FogLightConfig,
  FogLightUpdate,
  FogLight
> {
