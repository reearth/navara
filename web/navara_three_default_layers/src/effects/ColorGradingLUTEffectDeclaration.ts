...
export type ColorGradingLUTConfig = LayerDescription & EffectConfig;

export type ColorGradingLUTUpdate = LayerDescription & EffectUpdate;

export class ColorGradingLUTEffectDeclaration extends EffectDeclaration<
