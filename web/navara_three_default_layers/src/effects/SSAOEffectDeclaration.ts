...
export type SSAOConfig = LayerDescription & EffectConfig;

export type SSAOUpdate = LayerDescription & EffectUpdate;

export class SSAOEffectDeclaration extends EffectDeclaration<
  SSAOConfig,
  SSAOUpdate,
  SSAO
> {
