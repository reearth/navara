...
vec3 modelHighDiff = u_modelPositionHigh - u_cameraPositionHigh;
vec3 modelLowDiff = u_modelPositionLow - u_cameraPositionLow;
...
mat4 modelViewMatrixRTE_Local = viewMatrixRTE * modelMatrix;
...
vec4 mvCenterOffset = viewMatrixRTE * vec4(modelCenterOffset, 0.0);
...
vec3 absTransformed = (u_modelPositionHigh + u_modelPositionLow) + rotatedScaledLocal;
